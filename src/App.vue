  ...
  <div id="app">
    <router-view></router-view>
		    <tabbar>
		      ...
		      <tabbar-item show-dot link="/f/exchange">
		        <img slot="icon" src="assets/demo/icon_nav_msg.png">
		        <span slot="label">充分兑分</span>
		      </tabbar-item>
		      <tabbar-item selected link="/f/player">
		        <img slot="icon" src="assets/demo/icon_nav_article.png">
		        <span slot="label">用户管理</span>
		      </tabbar-item>
		      <tabbar-item badge="2" link="/f/agency">
		        <img slot="icon" src="assets/demo/icon_nav_cell.png">
		        <span slot="label">代理管理</span>
		      </tabbar-item>
		    </tabbar>
  </div>
</template>
